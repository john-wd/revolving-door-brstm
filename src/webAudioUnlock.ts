export default function (ac: AudioContext): Promise<void> {
  return new Promise(async (resolve) => {
    let alreadyremoved = false;
    let unlockWrapper = document.createElement("div");
    unlockWrapper.setAttribute(
      "style",
      `background: #888a; z-index: 88888; position: fixed; top: 0; bottom: 0; left: 0; right: 0; display: flex; align-items: center; justify-content: center;`
    );
    let unlockPrompt = document.createElement("div");
    unlockPrompt.setAttribute(
      "style",
...
<path d="M48,27.6a19.5,19.5 0 0 1 0,21.4M55.1,20.5a30,30 0 0 1 0,35.6M61.6,14a38.8,38.8 0 0 1 0,48.6" style="fill:none;stroke:#fff;stroke-width:5;stroke-linecap:round"/>
    ...
    setTimeout(function () {
      if (!alreadyremoved) document.body.appendChild(unlockWrapper);
    }, 200);
