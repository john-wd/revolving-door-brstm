...
function addEventHandlers() {
    let audio = document.getElementById(configProvider_1.PLAYER_TAG_ID);
    if (audio) {
        audio.addEventListener(eventTypes_1.PlayerEvent.step, (evt) => {
        ...
        audio.addEventListener(eventTypes_1.PlayerEvent.killed, (evt) => {
        ...
        audio.addEventListener(eventTypes_1.PlayerEvent.setVolume, (evt) => {
            state.volume = evt.detail.volume;
            guiUpdate();
        });
        audio.addEventListener(eventTypes_1.PlayerEvent.seek, (evt) => {
            state.position = evt.detail.toSample;
            guiUpdate();
        });
        audio.addEventListener(eventTypes_1.PlayerEvent.playPause, (evt) => {
            state.paused = evt.detail.playing;
            guiUpdate();
        });
        audio.addEventListener(eventTypes_1.PlayerEvent.setLoop, (evt) => {
            state.looping = evt.detail.loop;
            guiUpdate();
        });
        audio.addEventListener(eventTypes_1.PlayerEvent.stop, (evt) => {
            destroyGui();
        });
        audio.addEventListener(eventTypes_1.PlayerEvent.start, (evt) => {
            state.loaded = evt.detail.loaded;
            state.display = true;
            guiUpdate();
        });
        audio.addEventListener(eventTypes_1.PlayerEvent.resetState, (evt) => {
        ...
        audio.addEventListener(eventTypes_1.PlayerEvent.loaded, (evt) => {
        ...
        audio.addEventListener(eventTypes_1.PlayerEvent.buffering, (evt) => {
